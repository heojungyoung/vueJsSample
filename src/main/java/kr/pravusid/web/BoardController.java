...
public class BoardController {
    ...
    public String list(@PageableDefault(size = 10, sort = "id", direction = Direction.DESC) Pageable pageable,
		 ...
		 * pagination).map(BoardDto::of); logger.info("검색요청: 필터-{}, 검색어-{}",
		 * pagination.getFilter(), pagination.getKeyword());
		 * 
	 ...
	 * @ResponseBody
	 * 
	 * @GetMapping("/data") public Page<BoardDto> getList(@PageableDefault(size= 10,
	 * sort = "id", direction = Direction.DESC) Pageable pageable, Pagination
	 * pagination) {
	 * 
	 ...
	 */
     ...
     @ResponseBody 
	 @GetMapping("/data") 
	 public HashMap<String, Object> getList(@PageableDefault(size= 10, sort = "id", direction = Direction.DESC) Pageable pageable, 
